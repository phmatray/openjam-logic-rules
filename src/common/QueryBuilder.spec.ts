...
describe('Test QueryBuilder', () => {
  ...
  describe('buildQueryForCollection', () => {
    it('should throw if the collection parameter is null', () => {
      expect(() => {
        queryBuilder.buildQueryForCollection(null);
      }).toThrow();
    });

    it('should throw if the collection parameter is undefined', () => {
      expect(() => {
        queryBuilder.buildQueryForCollection(undefined);
      }).toThrow();
    });

    it('should return the query string', () => {
      const url = queryBuilder.buildQueryForCollection('artist');
    ...
    it('should return the query string with all parameters', () => {
      ...
      const url = queryBuilder.buildQueryForCollection('artist', params);
    ...
    describe('parameters', () => {
      describe('skip', () => {
        it('should throw if the skip parameter is negative', () => {
          ...
          expect(() => {
            queryBuilder.buildQueryForCollection('artist', params);
          }).toThrow();
        });
